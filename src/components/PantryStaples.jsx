...
const productsData = [
  { id: 1, name: 'Rice and Dals',Category:'PantryStaples', price: 80, rating: 4.9, image: Pantry1 },
       { id: 2, name: 'Corn Flakes',Category:'PantryStaples', price: 100, rating: 4.1, image: Pantry2 },
       { id: 3, name: 'Combo Pack',Category:'PantryStaples', price: 30, rating: 4.3, image: Pantry3 },
       { id: 4, name: 'Channa',Category:'PantryStaples', price: 60, rating: 4.6, image: Pantry4 },
       { id: 5, name: 'Nuts',Category:'PantryStaples', price: 90, rating: 4.7, image: Pantry5 },
       { id: 6, name: 'Chilly Powder',Category:'PantryStaples', price: 50, rating: 4.5, image: Pantry6 },
       { id: 7, name: 'Cherry',Category:'PantryStaples', price: 40, rating: 4.3, image: Pantry7 },
       { id: 8, name: 'Turmeric',Category:'PantryStaples', price: 70, rating: 4.4, image: Pantry8 },
];
                  ...
                  <div key={product.id} className="col-md-4 mb-4">
                    <div className="card h-100">
                      <img
                        ...
                        onClick={() =>
                          navigate(`/product/pantrystaples/${product.id}`)
                        }
